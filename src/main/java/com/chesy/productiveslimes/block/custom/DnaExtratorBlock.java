...
public class DnaExtratorBlock extends Block implements BlockEntityProvider {
    ...
    public List<ItemStack> getDroppedStacks(BlockState state, LootContextParameterSet.Builder builder) {
        ...
        if (blockEntity instanceof DnaExtractorBlockEntity dnaExtractorBlockEntity) {
            ...
            nbt.putInt("energy", dnaExtractorBlockEntity.getEnergyHandler().getAmountStored());
    ...
    public void onPlaced(World world, BlockPos pos, BlockState state, @Nullable LivingEntity placer, ItemStack itemStack) {
        ...
        if (be instanceof DnaExtractorBlockEntity dnaExtractorBlockEntity) {
            if(itemStack.hasNbt() && itemStack.getNbt() != null && itemStack.getNbt().contains("energy")){
                dnaExtractorBlockEntity.getEnergyHandler().setAmount(itemStack.getOrCreateNbt().getInt("energy"));
            }
        }
