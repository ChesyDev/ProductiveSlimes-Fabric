...
public class MeltingStationBlock extends Block implements BlockEntityProvider {
    ...
    public List<ItemStack> getDroppedStacks(BlockState state, LootContextParameterSet.Builder builder) {
        ...
        if (blockEntity instanceof MeltingStationBlockEntity meltingStationBlockEntity) {
            ...
            tag.putInt("energy", meltingStationBlockEntity.getEnergyHandler().getAmountStored());
            stack.setNbt(tag);
    ...
    public void onPlaced(World world, BlockPos pos, BlockState state, @Nullable LivingEntity placer, ItemStack itemStack) {
        ...
        if (be instanceof MeltingStationBlockEntity meltingStationBlockEntity) {
            if(itemStack.hasNbt() && itemStack.getNbt() != null && itemStack.getNbt().contains("energy")){
                meltingStationBlockEntity.getEnergyHandler().setAmount(itemStack.getOrCreateNbt().getInt("energy"));
            }
        }
