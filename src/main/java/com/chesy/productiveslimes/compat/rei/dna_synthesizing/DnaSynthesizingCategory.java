    ...
    public List<Widget> setupDisplay(DnaSynthesizingRecipeDisplay display, Rectangle bounds) {
        ...
        widgets.add(new Widget() {
            ...
            public void render(DrawContext guiGraphics, int mouseX, int mouseY, float partialTick) {
                ...
                guiGraphics.drawTexture(RenderPipelines.GUI_TEXTURED, TEXTURE, startPoint.x + 77, startPoint.y + 38, 153, 0, arrowWidth, 8, 256,256);
                ...
                guiGraphics.drawTexture(RenderPipelines.GUI_TEXTURED, TEXTURE, startPoint.x + 36, startPoint.y + 30, 153, 66, 6, dnaHeight, 256,256);
            }
