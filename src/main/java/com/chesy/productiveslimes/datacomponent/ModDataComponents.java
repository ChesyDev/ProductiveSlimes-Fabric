...
public class ModDataComponents {
    ...
    public static ComponentType<SlimeData> SLIME_DATA = Registry.register(Registries.DATA_COMPONENT_TYPE, Identifier.of(ProductiveSlimes.MOD_ID, "slime_data"), ComponentType.<SlimeData>builder().codec(SlimeData.CODEC).build());
