...
public class SlimeModel extends EntityModel<EntityRenderState> {
    ...
    public static final EntityModelLayer SLIME_TEXTURE =
            new EntityModelLayer(Identifier.of(ProductiveSlimes.MOD_ID, "textures/entity/template_slime_entity.png"), "main");

    protected SlimeModel(ModelPart root, int color) {
        super(root);
        this.color = color;
    }
    ...
    public static TexturedModelData getInnerTexturedModelData() {
        ...
        modelPartData.addChild(
                "right_eye", ModelPartBuilder.create().uv(32, 0).cuboid(-3.25F, 18.0F, -3.5F, 2.0F, 2.0F, 2.0F), ModelTransform.NONE
        );
