...
public class ModItems {
    ...
    public static final Item SLIME_NEST_SPEED_UPGRADE_1 = register("slime_nest_speed_upgrade_1", new NestUpgradeItem(new Item.Settings(), 1.5f));
    public static final Item SLIME_NEST_SPEED_UPGRADE_2 = register("slime_nest_speed_upgrade_2", new NestUpgradeItem(new Item.Settings(), 2f));
