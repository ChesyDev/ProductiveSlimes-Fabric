...
public class SolidingStationMenu extends ScreenHandler {
    ...
    public SolidingStationMenu(int syncId, PlayerInventory inv, BlockEntity entity, PropertyDelegate data) {
        ...
        this.addSlot(new SolidingStationInputSlot(inventory, 0, 34, 34, blockEntity));

        ItemStack inputHandler = blockEntity.getInputHandler();
        this.addSlot(new SolidingStationBucketSlot(inventory, 1, 115, 34));

        ItemStack outputHandler = blockEntity.getOutputHandler();
        this.addSlot(new SolidingStationOutputSlot(inventory, 2, 135, 34));
