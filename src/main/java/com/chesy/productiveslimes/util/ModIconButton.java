...
public class ModIconButton extends ButtonWidget {
    ...
    public ModIconButton(int x, int y, int width, int height, net.minecraft.text.Text message, int closedTextureX, int closedTextureY, int openTextureX, int openTextureY, PressAction onPress) {
    ...
    protected void drawIcon(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        context.drawTexture(RenderPipelines.GUI_TEXTURED, iconTexture, this.getX(), this.getY(), textureX, textureY, this.width, this.height, 256, 256);
