...
public class ModIconButton extends ButtonWidget {
    ...
    public ModIconButton(int x, int y, int width, int height, Text message, int closedTextureX, int closedTextureY, int openTextureX, int openTextureY, PressAction onPress) {
